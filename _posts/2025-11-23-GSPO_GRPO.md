...
<div style="background-color: #f5f5f5; padding: 20px; border-radius: 5px; font-family: monospace; margin: 20px 0;">
<strong>GRPO Token-Level Weighting:</strong><br>
Token:  [  1  ] [  2  ] [  3  ] ... [ 999 ] [1000]<br>
Weight: [0.8 ] [2.1 ] [0.3 ] ... [1.7 ] [0.1 ]<br>
<span style="color: #d32f2f;">→ High variance, noisy gradients</span><br><br>

<strong>GSPO Sequence-Level Weighting:</strong><br>
Token:  [  1  ] [  2  ] [  3  ] ... [ 999 ] [1000]<br>
Weight: [1.05] [1.05] [1.05] ... [1.05] [1.05]<br>
<span style="color: #1976d2;">→ Uniform, stable gradients</span>
</div>
...
![Training Stability Comparison](/assets/images/gspo-vs-grpo-stability.png)
