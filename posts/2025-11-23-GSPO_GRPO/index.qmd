...
image: "/files/images/gspo_vs_grpo.png"
---
<script>
MathJax = {
  tex: {
...
![Token-Level vs Sequence-Level Weighting](/files/images/img/gspo_vs_grpo.png)
...
<div style="max-width: 100%; overflow-x: auto; margin: 20px 0;">
  <img src="/files/images/gspo-vs-grpo-stability.png" alt="Training Stability Comparison" style="max-width: 100%; height: auto; display: block;">
</div>
